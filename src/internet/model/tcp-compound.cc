...
TcpCompound::GetTypeId()
{
  static TypeId tid = TypeId ("ns3::TcpCompound")
        ...
        .AddAttribute("Alpha",
                   "Alpha for multiplicative increase of m_cWnd",
                   DoubleValue(0.125),
                   MakeDoubleAccessor(&TcpCompound::m_alpha),
                   MakeDoubleChecker<double>(0.0, 1.0))
        .AddAttribute("Beta", 
                   "Beta for multiplicative decrease of m_cWnd",
                   DoubleValue(0.5),
                   MakeDoubleAccessor(&TcpCompound::m_beta),
                   MakeDoubleChecker<double>(0.0, 1.0))
        .AddAttribute("eta",
                  "Eta for additive decrease of m_dwnd",
                   DoubleValue(1.0),
        ...
        .AddAttribute ("k", "Exponent for multiplicative increase of m_cWnd",
                   ...
                   MakeDoubleChecker<double>(0.0, 1.0))
        .AddAttribute("lamda", 
                   "Weight used to calculate gamma",
                   DoubleValue(0.8),
...
void
TcpCompound::PktsAcked(Ptr<TcpSocketState> tcb, uint32_t segmentsAcked, const Time& rtt)
{
...
void
TcpCompound::CongestionStateSet(Ptr<TcpSocketState> tcb, const TcpSocketState::TcpCongState_t newState)
{
...
uint32_t
TcpCompound::GetSsThresh(Ptr<const TcpSocketState> tcb,uint32_t bytesInFlight)
{
